...
import { ArrowLeft, ArrowRight, Book, ChevronRight, ExternalLink, Menu } from "lucide-react";
...
const mdxComponents = {
  ...
  h2: (props: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight mt-10 first:mt-0" {...props} />
  ),
  ...
  Card: ({ title, description, href }: { title: string; description?: string; href: string }) => (
    <Link to={href}>
...
function DocsSidebar({ tree, currentPath }: { tree: object; currentPath: string }) {
